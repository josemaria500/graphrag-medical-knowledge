...
def render():
    ...
    # ─── Ejemplos rápidos (con fix de on_click) ───
    def set_chat_question(question_text: str):
        """Callback que se ejecuta ANTES del re-renderizado."""
        st.session_state.chat_question = question_text
